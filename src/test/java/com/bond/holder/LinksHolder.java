...
public abstract class LinksHolder {
    ...
    protected static final String REMOVE_ALL_USER_ROLES_FILE_PATH =
            "classpath:database/remove-all-users_roles-from-database.sql";
    ...
    protected static final String REMOVE_ALL_COMPANIES_FILE_PATH =
            "classpath:database/remove-all-companies.sql";
    protected static final String INSERT_COMPANY_FILE_PATH =
    ...
    protected static final String INSERT_REPORT_FILE_PATH =
            "classpath:database/insert-report-into-database.sql";
    protected static final String INSERT_FIVE_REPORTS_FILE_PATH =
            "classpath:database/insert-five-reports.sql";
}
